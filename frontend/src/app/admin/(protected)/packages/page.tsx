            ...
            <div className="grid gap-4 md:hidden">
              {packages.map((pkg) => (
                <MobileRecordCard
                  ...
                  badge={<StatusBadge published={pkg.published} />}
                  actions={
                    <>
                      {canEdit ? (
                      ...
                      <PublishToggleForm
                        ...
                        canEdit={canEdit}
                      />
                      <DeleteItemForm id={pkg.id} action={deletePackage} canEdit={canEdit} />
                    </>
                  }
                >
                  <MobileRecordRow label="Price" value={pkg.price_label} />
                </MobileRecordCard>
              ))}
            </div>
                    ...
                    <tbody>
                      {packages.map((pkg) => (
                        <tr key={pkg.id} className="border-b border-borderSoft">
                          ...
                          <td className="py-4">
                            <StatusBadge published={pkg.published} />
                          </td>
                          <td className="py-4">
